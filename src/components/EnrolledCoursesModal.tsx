...
export function EnrolledCoursesModal({ isOpen, onClose, courses }: EnrolledCoursesModalProps) {
  return (
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="pt-2 border-t">
                        <div className="text-sm">
                          ...
                          {course.recentAssignments.filter((a: any) => a.score).length} completed, {" "}
                          {course.recentAssignments.filter((a: any) => !a.score).length} pending
                        </div>
                      </div>
                    </div>
                  </div>
