...
export function AssignmentsView({ teacherData }: AssignmentsViewProps) {
  return (
          ...
          <TabsContent key={subject.id} value={subject.id} className="mt-4 space-y-4">
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <Card className="p-4">
                ...
                <div className="text-2xl text-red-600">
                  {subject.recentAssignments.reduce((sum: number, a: any) => sum + a.pending, 0)}
                </div>
              </Card>
              <Card className="p-4">
                <h4 className="mb-2">Avg Submission Rate</h4>
                <div className="text-2xl">
                  {Math.round((subject.recentAssignments.reduce((sum: number, a: any) => sum + a.submitted, 0) / 
            ...
            <Card className="p-4">
              ...
              <Table>
                ...
                <TableBody>
                  {subject.recentAssignments.map((assignment: any, idx: number) => (
                    <TableRow key={idx}>
