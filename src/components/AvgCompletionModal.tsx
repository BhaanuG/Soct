...
interface AvgCompletionModalProps {
  isOpen: boolean;
  onClose: () => void;
  subjects: any[];
}
...
export function AvgCompletionModal({ isOpen, onClose, subjects }: AvgCompletionModalProps) {
                ...
                .map((subject, index) => (
                  <div key={index} className="p-4 border rounded-lg">
                    ...
                    <div className="mt-3 grid md:grid-cols-2 gap-2">
                      {subject.outcomes.slice(0, 4).map((outcome: any, outcomeIndex: number) => (
